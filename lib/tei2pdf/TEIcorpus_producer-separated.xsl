...
<xsl:stylesheet
    ...
    <xsl:variable name="types">
        <type>
            <item>Keynote</item> <!-- 2018, 2019, 2020 -->
            <item>Workshop</item> <!-- 2016, 2017, 2018, 2019, 2020 -->
            <item>Panel</item> <!-- 2016, 2017, 2018, 2019, 2020 -->
            <item>Vortrag</item> <!-- 2016, 2017, 2018, 2019, 2020 -->
            <item>Poster</item> <!-- 2016, 2017, 2018 -->
            <item>Posterpräsentation</item> <!-- 2019, 2020 -->
            <item>Sektion</item> <!-- 2016 -->
            <item>Doctoral Consortium</item> <!-- 2020 -->
            <item>Plenary</item> <!-- 2016, 2017 --> 
            <item>Vortrag: Tool oder Resource</item> <!-- 2025 -->
            <item>Vortrag: Methode</item> <!-- 2025 -->
            <item>Vortrag: Theorie, Metareflexion, Positionspapier</item> <!-- 2025 -->
            <item>Vortrag: Offenes Feld</item> <!-- 2025 -->
            <item>Vortrag: Computergestützte Analyse oder Interpretation</item> <!-- 2025 -->
        </type>
    </xsl:variable> 
      <xsl:template match="/">
