...
<!-- Stagger the pages for print but not PDF -->
  ...
  <xsl:variable name="main_font">Noto Sans Ethiopic</xsl:variable>
  ...
  <xsl:template name="head">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$output = 'pdf'">
        ...
        <xsl:attribute name="color">#355A6F</xsl:attribute> <!-- DH2022 green -->
      </xsl:when>
    </xsl:choose>
    <xsl:attribute name="space-before">.2in</xsl:attribute>
    <xsl:attribute name="space-after">.2in</xsl:attribute>
  ...
  <xsl:template name="section_head">  <!-- For Panel, Paper, and Poster head pages-->
    ...
    <xsl:choose>
      ...
      <xsl:when test="$output = 'pdf'"> 
        <!-- <xsl:attribute name="color">#d00011</xsl:attribute> --> <!-- red -->
        <!-- <xsl:attribute name="color">#ffc000</xsl:attribute> --> <!-- happy yellow -->
        <xsl:attribute name="color">#687E70</xsl:attribute> <!-- DH2022 green -->
      </xsl:when>
    </xsl:choose>
 ...
 <!-- <xsl:template match="//term[text()='Keynote']" mode="toc">
  ...
  <!--      <fo:page-sequence master-reference="Single">
     ...
     <!--   <fo:page-sequence master-reference="Single">
      ...
      <!-- ~~~~~~~~~~~~~~~~~~
      Vortrag: Computergestützte Analyse oder Interpretation
      ~~~~~~~~~~~~~~~~~~~~~ -->
      ...
      <!-- ~~~~~~~~~~~~~~~~~~
      Vortrag: Theorie, Metareflexion, Positionspapier
      ~~~~~~~~~~~~~~~~~~~~~ -->
